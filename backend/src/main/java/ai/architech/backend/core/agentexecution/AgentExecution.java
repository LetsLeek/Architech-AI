...
public class AgentExecution {
	...
	public void fail(String reason) {
		if (status == AgentExecutionStatus.SUCCEEDED || status == AgentExecutionStatus.FAILED) {
			throw new IllegalStateException("Cannot fail an execution that already finished as " + status);
		}
